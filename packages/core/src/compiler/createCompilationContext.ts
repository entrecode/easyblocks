...
> {
  return {
    space: {
      ...
      widget: { id: "@ecblocks/space", label: "Space" },
      allowCustom: true,
      validate(value) {
    ...
    color: {
      ...
      widget: { id: "@ecblocks/color", label: "Color" },
      allowCustom: true,
      validate(value) {
    ...
    aspectRatio: {
      ...
      token: "aspectRatios",
      responsiveness: "always",
      widget: { id: "@ecblocks/aspectRatio", label: "Aspect ratio" },
    ...
    icon: {
      ...
      widget: { id: "@ecblocks/icon", label: "Icon" },
      allowCustom: true,
      validate(value) {
